...
const Shop = () => {
  ...
  return (
    <div className='max-w-[1300px] h-full mx-auto p-10'>
      <h1 className='flex justify-center font-semibold text-xl'>All products</h1>
      <div className='grid justify-center sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-8 mt-5 p-3 '>
        {rows.map((item,index)=>
        <div className='w-[230px] rounded-xl shadow-md border-2 h-[320px] hover:scale-105 cursor-pointer p-3 ' onClick={()=>handleproductclick(item)}>
